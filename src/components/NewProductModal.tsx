...
export default function NewProductModal() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      >
        <ModalContent className="bg-card-bg-color rounded-lg w-auto lg:min-w-[650px]">
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <div>
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3 items-start h-max">
                    <div>
