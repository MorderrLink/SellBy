      ...
      <div className='flex flex-row flex-wrap gap-2'>
        <div className="flex flex-wrap gap-2">
          ...
          {value?.map(({ file, progress }, index) => (
            <div
              key={index}
              className={variants.image + ' aspect-square h-32 w-32 max-h-32 max-w-32'}
            >
              <img
              ...
              {imageUrls[index] && !disabled && progress === 'PENDING' && (
                ...
                >
                  <div className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md border border-solid border-[#f9f9fc] bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:border-gray-400 dark:bg-black">
                    <X
                      className="text-gray-500 dark:text-[#f9f9fc]"
                      width={16}
                      height={16}
                    />
                  </div>
          ...
          {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-[#f9f9fc]">
                <UploadCloudIcon className="mb-2 h-7 w-7" />
                <div className="text-[#f9f9fc]">drag & drop to upload</div>
                <div className="mt-3">
                  <Button disabled={disabled} type='button'>select</Button>
                </div>
              </div>
            </div>
          )}
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        'border border-[#f9f9fc] text-[#f9f9fc] shadow hover:bg-gray-100 hover:text-gray-500 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700',
        // size
